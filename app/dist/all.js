		...
		function ($scope,$routeParams,user,socket) {
			...
			$scope.addToFriendList = function(friendUsername){
				...
				if(addFriendPromise !== false){
					addFriendPromise(friendUsername).success(){
